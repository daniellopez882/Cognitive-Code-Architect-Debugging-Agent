...
def checkout_branch(repo_path: str, branch_name: str) -> dict:
    ...
    try:
        ...
        return {"status": "success", "current_branch": repo.active_branch.name}
    except GitCommandError as e:
        return {"status": "error", "error": str(e)}
...
def create_fix_branch(repo_path: str, branch_name: str) -> dict:
    ...
    try:
        ...
        return {"status": "success", "branch_name": branch_name, "based_on": str(repo.head.commit)}
    except GitCommandError as e:
        return {"status": "error", "error": str(e)}
...
@tool
def commit_and_push(
    repo_path: str, files: list[str], message: str, remote: str = "origin", branch: str = "main"
) -> dict:
    """
